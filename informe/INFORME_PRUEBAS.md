...
- **Fecha de ejecución:** 23/09/2026 16:07 Hora est. Pacífico, Sudamérica
...
|---|---|---|---|---|---|---|---|---|
| 2023-03-11 | lluvias del ciclón Yaku | 14.19 | 0.918 | Muy alto | 45 | 73 555 | no | 1.59 ms |
| 2017-03-16 | Niño Costero | 9.2 | 0.812 | Muy alto | 35 | 55 845 | sí | 1.51 ms |
| 2007-01-09 | evento registrado en SINPAD | 8.85 | 0.756 | Muy alto | 35 | 55 845 | sí | 1.3 ms |
| 2015-08-03 | estiaje, sin evento | 0 | 0.086 | Bajo | 0 | 0 | no | 1.03 ms |
| 2020-07-15 | invierno seco, sin evento | 0.09 | 0.097 | Bajo | 0 | 0 | no | 1.0 ms |
...
|---|---|---|---|
| salud | `/api/salud` | 3.7 ms | 4.69 ms |
| celdas | `/api/celdas` | 12.32 ms | 18.79 ms |
| riesgo | `/api/riesgo?fecha=2023-03-11` | 5.27 ms | 6.89 ms |
| celda | `/api/celda/PP0500_R0011_C0014?fecha=2023-03-11` | 3.97 ms | 5.29 ms |
| precipitacion | `/api/precipitacion?hasta=2023-03-11&dias=14` | 3.25 ms | 3.85 ms |
