...
- **Fecha de ejecución:** 23/09/2026 17:35 Hora est. Pacífico, Sudamérica
...
|---|---|---|---|---|---|---|---|---|
| 2023-03-11 | lluvias del ciclón Yaku | 14.19 | 0.918 | Muy alto | 45 | 73 555 | no | 1.35 ms |
| 2017-03-16 | Niño Costero | 9.2 | 0.812 | Muy alto | 35 | 55 845 | sí | 1.22 ms |
| 2007-01-09 | evento registrado en SINPAD | 8.85 | 0.756 | Muy alto | 35 | 55 845 | sí | 1.09 ms |
| 2015-08-03 | estiaje, sin evento | 0 | 0.086 | Bajo | 0 | 0 | no | 0.86 ms |
| 2020-07-15 | invierno seco, sin evento | 0.09 | 0.097 | Bajo | 0 | 0 | no | 0.86 ms |
...
|---|---|---|---|
| salud | `/api/salud` | 3.28 ms | 4.04 ms |
| celdas | `/api/celdas` | 13.89 ms | 16.94 ms |
| riesgo | `/api/riesgo?fecha=2023-03-11` | 5.48 ms | 7.45 ms |
| celda | `/api/celda/PP0500_R0011_C0014?fecha=2023-03-11` | 3.72 ms | 4.52 ms |
| precipitacion | `/api/precipitacion?hasta=2023-03-11&dias=14` | 2.97 ms | 3.26 ms |
